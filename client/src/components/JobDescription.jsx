        ...
        <div className='flex items-center justify-between'>
            <div>
                ...
                <div className='flex items-center gap-2 mt-4'>
                    <Badge className={'text-blue-400 font-bold'} variant='ghost'>12 Position</Badge>
                    <Badge className={'text-[#f83002] font-bold'} variant='ghost'>part ime </Badge>
                    <Badge className={'text-[#7209b7] font-bold'} variant='ghost'>12 laks</Badge>
                </div>
            </div>
            <Button disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : "bg-[#7209b7] hover:bg-[#5f32af]"} `}>
